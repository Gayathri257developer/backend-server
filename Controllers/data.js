const data = (req, res) =>{
    ...
    {
      "id": "14",
      "title": "Kantara Hindi box office collection Day 7: Rishab Shetty's film continues to impress",
      "description": " Kantara turned out to be the highest-rated Indian film beating Yash's KGF: Chapter 2. The film has been receiving rave reviews from critics and audiences alike. Rishab Shetty-directed Kannada action drama is unstoppable at the box office. The actor-filmmaker has scored a big hit with Kantara. The film received rave reviews, with critics praising the performances and execution. On October 20, the Hindi version completed seven in the theatres. Reports suggest that the film will soon cross the Rs 15-crore mark at the box office now. At this rate, Kantara is likely to have a long run in the theatres.",
      "category": "Bollywood",
      "date": "Octomber 20, 2022",
      "image": "https://akm-img-a-in.tosshub.com/indiatoday/images/story/202210/kantara-budget-box-office-collection-sixteen_nine.jpg?VersionId=YAklWpVyJvZSx8PlOmjzLOOze7vCkTC5&size=690:388"
